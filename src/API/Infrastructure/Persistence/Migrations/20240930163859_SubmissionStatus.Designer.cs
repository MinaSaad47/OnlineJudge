...
namespace OnlineJudge.API.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240930163859_SubmissionStatus")]
            ...
            modelBuilder.Entity("OnlineJudge.API.Domain.Entities.Submission", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("StatusRepresentation", "OnlineJudge.API.Domain.Entities.Submission.StatusRepresentation#SubmissionStatusRepresentation", b1 =>
                        {
                            b1.IsRequired();
