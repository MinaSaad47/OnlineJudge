...
{
    /// <inheritdoc />
    public partial class UsersAndLanguages : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompileCmd = table.Column<string>(type: "text", nullable: true),
                    RunCmd = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Language",
                columns: new[] { "Id", "CompileCmd", "Name", "RunCmd", "SourceFile" },
                values: new object[,]
                {
                    { "c", "gcc -o main.c", "C", "./a.out", "main.c" },
                    { "cpp", "g++ -o main.cpp", "C++", "./a.out", "main.cpp" },
                    { "java", "javac Main.java", "Java", "java Main", "Main.java" },
                    { "py", null, "Python", "python3 main.py", "main.py" }
                });
