...
namespace OnlineJudge.API.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240929153535_TestCases Json")]
    partial class TestCasesJson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineJudge.API.Domain.Entities.Problem", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.List<OnlineJudge.API.Domain.Entities.TestCase>", "TestCases", b1 =>
                        {
